...
export default function StartScreen() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-6 dot-grid overflow-hidden">
      ...
      <div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-white/[0.03] blur-[120px]" />

      <div className="relative z-10 w-full max-w-xl text-center">

        {/* 아이덴티티 레이블 */}
        <p className="font-mono text-white text-[10px] tracking-[0.25em] uppercase mb-10">
        ...
        <h1 className="text-5xl font-extrabold leading-[1.1] tracking-tight mb-5 text-slate-50">
          감정이<br />
          <span className="text-white">결정</span>을 바꿉니까?
        </h1>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-10 py-4 border border-white/60 text-white font-bold text-base rounded-full transition-all duration-200 hover:bg-white hover:text-black hover:border-white"
        >
          진단 시작
